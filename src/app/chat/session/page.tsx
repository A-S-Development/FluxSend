...
const ChatSession: React.FC = () => {
  ...
  const senderMessages = [
    { 
      ...
      "account sid": "AC3fe73880522d61aa1837feef9737df02",
      "nun media": "0", 
      "to": "+48537425314",
  ...
  const determineSender = (message) => {
    if (message["from"] === "sender") {
      return (
        { bgcolor: 'green', height: '50px', marginLeft: 10, borderRadius: "0% 30% 30% 30%", maxHeight: 'fit-content', maxWidth: 'fit-content', padding: '10px'}
      )
    } else if (message["from"] === "recipient") {
      return (
        { bgcolor: 'blue', height: '50px', alignSelf: 'flex-end', marginRight: 10, borderRadius: "30% 30% 0% 30%", maxHeight: 'fit-content', maxWidth: 'fit-content', padding: '10px' }
      )
    }
  }
